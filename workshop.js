document.addEventListener('DOMContentLoaded', () => {
            ...
            .then((snapshot) => {
                ...
                snapshot.forEach((doc) => {
                    ...
                    workshopCard.innerHTML = `
                        ...
                        <button class="mt-6 bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition-colors w-full sm:w-auto" data-id="${workshopId}">Register</button>
                    `;
    ...
    function registerForWorkshop(workshopId) {
        ...
        alert(`Registering for workshop with ID: ${workshopId}`);
    }
            ...
            .then((snapshot) => {
                ...
                snapshot.forEach((doc) => {
                    ...
                    workshopCard.innerHTML = `
                        ...
                        } text-white px-6 py-2 rounded-lg transition-colors w-full sm:w-auto" data-id="${workshopId}" ${
